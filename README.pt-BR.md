...
![O agente rodando no terminal embutido, com o explorador de arquivos marcando o status de git de cada arquivo](docs/img/terminal.png)
...
Execute o `.exe`, escolha a pasta de instalação e pronto — cria atalho na área de trabalho e no menu iniciar.

O instalador usa a mesma identidade visual do app — a arte é gerada por `build/make-installer-art.ps1`:
...
### "O Windows protegeu seu PC" / o antivírus acusa vírus
